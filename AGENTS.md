...
- La tanda 02A conserva el Host candidato en Development/Reliability/NativeCandidates/Host/. No es fuente original recuperada ni autoriza reemplazo; 02B ya comparo y corrigio la candidata. Retomar 03B segun NEXT_SESSION.md; 02C resolvera los bloqueos Host antes de 05. El paquete sigue con build s01b porque no cambio en 02A.
- 03A conserva Runtime candidato en NativeCandidates/Runtime/, receta offline y contrato UI. No instalarlo ni repetir 03A: revisar 03B antes del acuerdo Host/UI de 02C.
