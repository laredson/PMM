# PMM v1.1 — Windows / Palworld validation plan

Build ID expected everywhere: `PMM-v1.1`

Use this checklist to repeat the release validation on Windows/Palworld.

## A. Clean extraction / identity

- [ ] Extract the ZIP into a **new empty folder**.
- [ ] Confirm `BUILD_ID.txt` contains `PMM-v1.1`.
- [ ] Launch only that extraction via `Start.cmd`.
- [ ] Confirm the title shows `Palworld Manager Merger v1.1`.
...
- [ ] Do not deliberately corrupt dependencies on the release test machine unless you want to test repair separately.
