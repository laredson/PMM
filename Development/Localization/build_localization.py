...
def repair_and_complete_catalogs():
    ...
    curated.update({'+ New case': '+ 新建案例', 'Projects': '项目', 'Send to ChatGPT': '发送到 ChatGPT', 'Options': '选项', 'Candidates': '候选', 'Cases': '案例', 'Newest first': '最新优先', 'Case': '案例', 'Last step': '上一步骤', 'Next step': '下一步骤', 'Delete case': '删除案例', 'No case selected': '未选择案例', 'Receive file...': '接收文件...', 'Create handoff': '创建交接包', 'Save': '保存', 'AI client': 'AI 客户端', 'Advanced: other MCP client': '高级：其他 MCP 客户端', 'Advanced: internal agent': '高级：内部代理', 'Mode': '模式', 'Question': '问题', 'Detect modes': '检测模式', 'Last Step': '上一步', 'Current': '当前', 'Select a case': '选择案例', 'Select or create a case': '选择或创建案例', 'Title': '标题', 'Type': '类型', 'Description / goal': '描述 / 目标', 'AI response': 'AI 响应', 'References and evidence': '参考与证据', 'Kind': '类型', 'Source': '来源', 'Selection': '选择', 'Folders': '文件夹', 'Research cases': '研究案例', 'Workflow': '工作流', 'AI assistant': 'AI 助手', 'Mod Creation': '模组创建', 'Help': '帮助', 'General': '常规', 'AI / MCP': 'AI / MCP', 'Installations': '安装', 'Mods & Merge': '模组与合并', 'Feedback & Knowledge': '反馈与知识', 'Color scheme editor': '配色方案编辑器', 'Refresh': '刷新', 'Cancel': '取消', 'CANCEL': '取消', 'Close': '关闭', 'Optional tools and AI clients': '可选工具与 AI 客户端', 'Ask before each installation': '每次安装前询问', 'Change permissions': '更改权限', 'Installation tutorial': '安装教程', 'Installations and status': '安装与状态', 'Open': '打开', 'Locate...': '定位...', 'Detected': '已检测', 'Not detected': '未检测', 'Install / complete': '安装 / 完成', 'Detect installed tools': '检测已安装工具', 'Install missing components': '安装缺失组件', 'Cancel pending installations': '取消待处理安装', 'Install modding tools': '安装模组制作工具', 'Install everything needed without asking again': '安装所需全部组件，不再询问', 'Accept': '接受', 'Dependencies': '依赖项', 'Unreal requires version 5.1.1 for the supported Palworld kit. PMM opens Epic Launcher; in Unreal Engine > Library, add/select 5.1.1 manually, then Install. The launcher may suggest a newer version. Quixel Bridge is optional and is not required by PMM.': '受支持的 Palworld 工具包需要 Unreal 5.1.1。PMM 会打开 Epic Launcher；请在 Unreal Engine > Library 中手动添加或选择 5.1.1，然后安装。启动器可能会推荐更新版本。Quixel Bridge 为可选组件，PMM 不需要它。', 'Wwise 2021.1.11: PMM detects the installed SDK and offline downloads separately. Downloading an offline package does not install the SDK. Use Install / complete to open the official installer, or Locate to select an existing folder or executable. The Unreal integration is a separate package.': 'Wwise 2021.1.11：PMM 会分别检测已安装的 SDK 和离线下载包。下载离线包并不等于安装 SDK。使用“安装 / 完成”打开官方安装程序，或使用“定位”选择现有文件夹或可执行文件。Unreal 集成是独立的软件包。', 'Open Wwise offline folder': '打开 Wwise 离线文件夹', 'Wwise Unreal integration: in Audiokinetic Launcher, open Unreal Engine > Download > Offline integration files, choose 2021.1.11 and save in the integration folder below. PMM detects Unreal.5.0.tar.xz automatically; Locate also accepts a download saved elsewhere.': 'Wwise Unreal 集成：在 Audiokinetic Launcher 中打开 Unreal Engine > Download > Offline integration files，选择 2021.1.11，并保存到下方的集成文件夹。PMM 会自动检测 Unreal.5.0.tar.xz；“定位”也可选择保存在其他位置的下载文件。', 'Open integration download folder': '打开集成下载文件夹', 'ChatGPT Desktop (optional AI client)': 'ChatGPT Desktop（可选 AI 客户端）', 'Offline package ready; SDK not installed': '离线包已就绪；SDK 尚未安装', 'Offline package rejected; inspect location': '离线包无效；请检查位置', '.NET runtime missing': '缺少 .NET 运行时', 'AI assistance / reception': 'AI 协助 / 接收', 'A repairable legacy mod was detected. Open Fix Lab.': '检测到可修复的旧版模组。请打开 Fix Lab。', 'A supported legacy mod was detected. Open Fix Lab to load its repair recipe.': '检测到受支持的旧版模组。请打开 Fix Lab 加载修复配方。', 'AUTO workflow': 'AUTO 工作流', 'Automatic detection is recommended. Manual Steam and Palworld selectors are available here for unusual installations.': '建议使用自动检测。对于特殊安装位置，可在此手动选择 Steam 或 Palworld 文件夹。', 'Automatic workflow complete. Palworld launch is optional.': '自动工作流已完成。是否启动 Palworld 由你决定。', 'QUEUED': '排队中', 'RUNNING': '运行中', 'WAITING_EXTERNAL': '等待外部操作', 'AWAITING_CONSENT': '等待确认', 'COMPLETE': '已完成', 'FAILED': '失败', 'CANCELLED': '已取消'})
    zh.update(curated)
    for key in curated:
