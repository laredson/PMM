...
Use `Logs/PalModMerger.log` for setup/Analyze/Build/Deploy errors. For developer reports, include PMM version, active source hashes where practical, the relevant AI_HANDOFF/review case, and exact error text.
