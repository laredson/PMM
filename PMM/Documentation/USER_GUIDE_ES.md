# Palworld Manager Merger v1.2.1 — Guía de usuario

**Flujo guiado:** PMM ilumina solo la siguiente etapa util del recorrido normal: **Importar -> Analizar -> Build -> Deploy**. El color depende del estado real, por lo que una etapa ya completada/actual vuelve al estilo neutro normal.
...
instalado dentro de `Workspace/GameReference` y nunca modifica el juego.
