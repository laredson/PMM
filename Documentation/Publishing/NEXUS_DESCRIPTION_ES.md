...
2. Ejecuta `Start.cmd` (la primera vez puede preparar/descargar las dependencias fijadas).
...
Si aparece un conflicto Unsupported, los usuarios avanzados pueden generar un paquete **AI_HANDOFF** con los archivos y análisis relevantes de ese caso exacto. Un desarrollador o una IA capaz puede investigarlo y devolver una solución en el formato documentado por PMM.
